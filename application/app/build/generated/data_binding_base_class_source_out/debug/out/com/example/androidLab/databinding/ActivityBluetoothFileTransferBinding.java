...
public final class ActivityBluetoothFileTransferBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityBluetoothFileTransferBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityBluetoothFileTransferBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityBluetoothFileTransferBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_bluetooth_file_transfer, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityBluetoothFileTransferBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBluetoothFileTransferBinding((ConstraintLayout) rootView, buttonBack,
